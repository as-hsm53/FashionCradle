...
class lumise_connector {
    ...
    public function __construct() {
        ...
        $this->config = array(
            ...
            "upload_path" => 'D:\\www\\FashionCradle\\data\\',
			"upload_url" => 'http://localhost:2124/FashionCradle/data/',
	...
	public function update() {
		...
		if (!empty($connector_content)) {
			...
			$connector_content = str_replace(array(
				'D:\\www\\FashionCradle\\data\\',
				'http://localhost:2124/FashionCradle/data/',
				'localhost',
                'root',
                '',
                'fashion',
