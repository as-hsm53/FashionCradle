...
?>
        ...
        <form action="<?php echo $lumise->cfg->url;?>index.php" method="post" class="form-horizontal" id="checkoutform" accept-charset="utf-8">
        <div class="container">
            <div class="row">
            	<div id="checkout" class="padding6 span12">
                    <?php if(count($items) > 0):?>
                        ...
                        <div class="col-md-6 order_overview">
                            ...
                            <input type="hidden" name="ins_order" value="placeorder">
                            <div class="form-actions">
                				<a href="<?php echo $lumise->cfg->url;?>cart.php?action=remove&item=<?php echo $item['cart_id'];?><?php echo $lumise->lang('Remove'); ?>"><button name="trial" class="btn btn-large btn-primary"><?php echo $lumise->lang('Place Order'); ?></button></a>
                			</div>
                        </div>
